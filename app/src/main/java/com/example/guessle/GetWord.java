...
public class GetWord extends AsyncTask<String, Integer, String> {

    private String rawJSON;

    private OnWordGeneration listener;

    public interface OnWordGeneration{
        void completeWordList(Word[] word);
    }


    public void setOnWordGenerationListener(OnWordGeneration listenerFromMain){
